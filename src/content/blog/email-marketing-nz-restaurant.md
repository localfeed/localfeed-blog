...
status: "published"
readTime: "6 min read"
targetKeyword: "email marketing nz restaurant"
---
...
**At the point of booking**: a booking form that includes an optional email field for "updates and offers" captures contacts passively. If you use [LocalFeed](https://localfeed.co.nz), the booking includes the diner's contact information.
...
- One upcoming special, event, or seasonal dish — the main reason they are reading
- One piece of genuine interest (a supplier story, a dish origin, a seasonal note that means something)
- A clear call to action: "Book for Thursday" with a link

**What to exclude**:

- Generic "we are so excited" announcements that say nothing specific
- Long newsletters with five items when one focused piece would perform better
- Anything that requires more than 90 seconds to read
...
The [social media strategy for NZ restaurants](/blog/social-media-nz-restaurants-that-works) complements email by feeding new contacts into the list-building pipeline — a follower who comes in once through an Instagram post becomes an email subscriber when the team makes the ask.
