...
status: "published"
readTime: "5 min read"
targetKeyword: "localfeed vs first table nz"
---
...
LocalFeed and First Table are both NZ hospitality platforms trying to fill tables. The models are different. The cost to venues is different. The customer relationship each creates is different. [LocalFeed](https://localfeed.co.nz) is the commission-free option — built for NZ venues that want full control of their offers and their margins.
