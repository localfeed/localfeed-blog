...
status: "published"
readTime: "7 min read"
targetKeyword: "food cost control nz restaurant"
---
...
- **Full-service restaurant kitchen**: 28%–35% is the target range. Below 28% often means portion sizes or quality have been compromised. Above 35% means the pricing, purchasing, or waste position needs attention.
- **Cafe kitchen**: 28%–38% depending on the menu mix. Cabinet food tends to run higher cost percentage than cooked dishes; beverage cost is typically lower.
- **Coffee**: 12%–20% gross cost percentage. If your coffee cost is above 20%, your bean price, yield, or pricing structure needs review.
- **Alcohol**: 18%–28% for wine and spirits. Draft beer runs 22%–30% depending on your keg deal and portion management.
...
- Actual cost more than 2 percentage points above target: investigate before it compounds
- Significant unexplained week-on-week movement: usually indicates a waste problem, a receiving problem, or a portioning issue
- Consistent seasonal movement: often reflects produce price changes and may require menu price adjustment
...
- **Know your top ten ingredients by spend** and review the pricing on each quarterly
- **Consolidate supplier count** where quality allows — fewer suppliers means stronger individual relationships and better leverage
- **Understand seasonal pricing patterns** for produce and adjust menus to use what is at price, not what you have always served
- **Ask for the trade price, not the listed price** — most NZ food service suppliers have room in their pricing for consistent customers who ask directly

The [NZ restaurant profit margins reality guide](/blog/restaurant-profit-margins-nz) puts food cost control in the context of the full P&L structure for different NZ venue types.
