...
status: "published"
readTime: "5 min read"
targetKeyword: "food waste reduction nz hospitality"
---
...
## Menu Simplification as Waste Reduction
...
Food waste reduction is one of the clearest margin improvements available to NZ hospitality venues. The venues that have done the work are eating better margins and running more sustainable operations. [LocalFeed](https://localfeed.co.nz) supports surplus food deals as part of its platform — giving venues a commission-free way to turn their end-of-service surplus into revenue rather than waste.
