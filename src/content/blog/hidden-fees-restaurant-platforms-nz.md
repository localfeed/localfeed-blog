...
status: "published"
readTime: "6 min read"
targetKeyword: "hidden fees restaurant platforms nz"
---
...
- Monthly subscription: $49–$149 NZD
- Per-cover commission: 1.5%–5% of booking value
- Payment processing: 1.5%–3.5% per transaction
- Setup and onboarding: anywhere from free to $500
...
A venue listing on [LocalFeed](https://localfeed.co.nz) at their own pricing, with full access to their customer data, pays $10 per week after the first 20 bookings. No commission. No forced discount. 75% of any no-show fee goes back to the venue.

On equivalent cover counts, the comparison is not subtle:

| Cost category | Commission platform | LocalFeed |
|---|---|---|
...
For a deeper look at how [what booking platforms actually cost NZ venues](/blog/what-booking-platforms-actually-cost-nz-venues) adds up across different venue types, the maths are consistent regardless of platform.
