...
status: "published"
readTime: "6 min read"
targetKeyword: "nz minimum wage hospitality impact"
---
...
1. How many team members are currently on or near minimum wage?
2. How many hours per week do they work collectively?
3. What is the wage increase in dollars per hour?
...
The venues managing the wage increase environment best are the ones that reduced their platform dependency alongside managing wages — moving to lower-cost or commission-free channels like [LocalFeed](https://localfeed.co.nz) as part of the margin management response.

For the full financial picture of how platform costs interact with venue economics, the [what booking platforms actually cost NZ venues guide](/blog/what-booking-platforms-actually-cost-nz-venues) runs the combined calculation.
