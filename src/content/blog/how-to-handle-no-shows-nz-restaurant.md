...
status: "published"
readTime: "5 min read"
targetKeyword: "how to handle no shows nz restaurant"
---
...
No-shows in NZ restaurants are a solvable problem. The solution is structural — deposits, reminders, and a platform that returns no-show fee revenue to the venue where it belongs. [LocalFeed](https://localfeed.co.nz) is built with this in mind.
